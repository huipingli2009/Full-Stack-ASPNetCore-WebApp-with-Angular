...
namespace org.cchmc.pho.api.Controllers
{
    ...
    public class PatientsController : ControllerBase
    {
        ...
        [Authorize(Roles = "Practice Member,Practice Admin,Practice Coordinator,PHO Admin,PHO Leader")]
        ...
        [HttpGet("duplicates")]
        [ResponseCache(Duration = 0, Location = ResponseCacheLocation.None, NoStore = true)]
        [Authorize(Roles = "Practice Admin,Practice Coordinator,PHO Admin,PHO Leader")]
